;--------------------------------------------------------------------
; loopplay_cia1_irq_singleNibble.asm
;
...
;--------------------------------------------------------------------
        ...
        !cpu 6510
        !to "loopplay_singleNibble.prg", cbm
...
playOneNibble:
    ...
    ldy #0
    lda (samplePtr),y
    beq resetPointer    ; saw sentinel => reset pointer => infinite loop
...
;-----------------------------------------
resetPointer:
    ; If 0 => sentinel => reset pointer => loop forever
    lda #<sampleData
    sta samplePtr
    lda #>sampleData
    sta samplePtr+1
